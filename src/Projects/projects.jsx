...
const Projects = () =>  {
  ...
  return (
    ...
    //   </div>
    // </div> */}
        <section id="services" class="services portfolio_section">
            ...
            <div class="container">
                <div class="row gy-4">
                    {projects.map((project) => (
                        <div key={project.title} class="col-lg-4 col-md-6 aos-init aos-animate" data-aos="fade-up" data-aos-delay="100">
                            <div class={`service-item  position-relative ${project.icon_color}`}>
                                <div class="icon">
